...
final Map<String,Garbage> garbages = {
  ...
  "toothpaste": const Garbage(name: "Tube de dentifrice",
      image: NetworkImage(
          "https://upload.wikimedia.org/wikipedia/commons/3/34/Charcoal_Toothpaste.jpg")),
  "teabag": const Garbage(name: "Sachet de thé",
      image: NetworkImage(
          "https://upload.wikimedia.org/wikipedia/commons/e/e1/Tea_bag_777.jpg")),
  "paperteabag": const Garbage(name: "Sachet de thé en papier",
      image: NetworkImage(
          "https://upload.wikimedia.org/wikipedia/commons/e/e1/Tea_bag_777.jpg")),
};

final Map<Garbage, Map<String, Garbage>> alternatives = {
  garbages["bottle"]!:{"Cette bouteille est en verre ?":garbages["glassbottle"]!},
  garbages["teabag"]!:{"Cette sachet est en papier ?":garbages["paperteabag"]!}

};
final Map<Garbage, List<String>> comments = {
  garbages["toothpaste"]!: ["Le tube doit être vide."],
  garbages["bottle"]!: ["Si la bouteille contient des produits corrosifs et-ou toxiques, elle se trie au recyparc - DSM (déchets spéciaux des ménages)"],
  garbages["glassbottle"]!: ["Les bouchons de bouteille de vin, de champagne et de cidre se trient au recyparc - bouchons de liège",
